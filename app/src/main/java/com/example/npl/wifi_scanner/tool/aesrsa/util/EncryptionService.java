package com.example.npl.wifi_scanner.tool.aesrsa.util;
...
public class EncryptionService {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String a=client(params);
        System.out.println(a);

        String b=server(JSONObject.parseObject(a).getString("data"),JSONObject.parseObject(a).getString("encryptkey"));
    }
...
//        System.out.println("加密后的请求数据:\n" + new Req().toString());
    ...
    public static String server(String encryptdata,String encryptkey) throws Exception {

        // 验签
        boolean passSign = EncryUtil.checkDecryptAndSign(encryptdata,
        ...
        if (passSign) {
            ...
            String aeskey = RSA.decrypt(encryptkey,
                    serverPrivateKey);
            String data = ConvertUtils.hexStringToString(AES.decryptFromBase64(encryptdata,
                    aeskey));
            return data;
